...
class Get_wrf(Get_data):
    ...
    def get_rain_hourly(self, ):
        ...
        file_list = []
        for i in model_list:
            # flnm = path + "RAINNC_May_"+i+'_latlon'
            flnm = path +str(self.var)+"_May_"+i+'_latlon'
...
class Get_obs(Get_data):
    ...
    def get_rain_hourly(self,):
        ...
        time_start = '20160501 0100'
        time_end= '20160601 0000'
...
class Return_data():
    ...
    def get_rain_specific_hour(self, sp_time):
        ...
        Args:
            sp_time [str]: '2016/05/02 12' 精确到小时
        """
    ...
    def get_rain_daily(self,):
        ...
        model_list = ['QNSE', 'QNSE_EDMF', 'TEMF','ACM2','YSU', 'obs']
        ...
        for j in model_list:  # 循环出每种降水
            ...
            time_array = pd.date_range(start='20160501', end='20160530', freq='1D')
    ...
    def get_rain_24hour_sequence(self, ):
        ...
        dic_model = {}
        time_start = '20160501 1300'
        time_start_end = '20160502 1200'

        time_array_start= pd.date_range(start=time_start, end=time_start_end, freq='1H')
        time_array_end= '20160531 1200'
    ...
    def get_rain_3hour_sequence(self,):
        ...
        for model in model_list:
            ...
            time_array = pd.date_range(start='20160501 03', end='20160502 00', freq='3H')
...
if __name__ == '__main__':
    ...
    aa = rd.get_rain_specific_day('2016/05/02 22')